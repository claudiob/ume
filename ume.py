...
for index, file in enumerate(sys.argv[1:]): # "~/Music/Albums/**/**/*.mp3"
    ...
    if "grouping" in id3 and "★" in id3["grouping"][0]: # pass an option to force this again
        print("\033[34mHas lyrics\033[0m")

    elif "grouping" in id3 and "☆" in id3["grouping"][0]: # pass an option to retry this
        print("\033[34mDoes not have lyrics\033[0m")
